...
const projects = [
  {
    name: "Car Rent",
    description:
      "Car rental project is a website that provides users with the ability to rent a car for a specific period of time. The website allows users to browse a variety of vehicles, compare prices and choose the car they want, and select the rental dates.",
    tags: [
      {
        name: "react",
